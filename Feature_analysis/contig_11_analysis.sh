...
for Assembly in $(ls assembly/miniasm/F.oxysporum_fsp_fragariae/DSA14_003/pilon/contig_11.fasta); do #pilon_10_renamed.fasta
    ...
    OutDir=assembly/miniasm/F.oxysporum_fsp_fragariae/DSA14_003/pilon/mimps_contig_11
    mkdir -p "$OutDir"
  ...
  # There are 45 sequences that contain the consensus mimp motif
